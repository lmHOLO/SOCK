package com.holo.sock.common.aop;
...
public class LogAop {
    ...
    @Before("execution(* com.holo.sock..*(..)) && !execution(* com.holo.sock.common..*(..))")
    public void before(JoinPoint joinPoint){
        log.info("[log] {} -> {} 실행", joinPoint.getSignature().getDeclaringType().getSimpleName() ,joinPoint.getSignature().getName());
    }

    @After("execution(* com.holo.sock..*(..)) && !execution(* com.holo.sock.common..*(..))")
